...
class FallingAsleep extends StatefulWidget {
  @override
  _FallingAsleepState createState() => _FallingAsleepState();
}

class _FallingAsleepState extends State<FallingAsleep> {
  ...
  void initState() {
    ...
    _player1
        .setAsset("audios/PinkNoise.mp3")
        .catchError((error){
      print(error);
    });
    _player2
        .setAsset("audios/RainyDay.mp3")
        .catchError((error){
      print(error);
    });
    _player3
        .setAsset("audios/Thunderstorm.mp3")
        .catchError((error){
      print(error);
    });
    _player4
        .setAsset("audios/Whitenoise.mp3")
        .catchError((error){
      print(error);
    });
        ...
        body: SingleChildScrollView(
          child: Column(
              children: [
                Stack(
                  children: <Widget>[
                    Image.asset("assets/3.jpeg",fit: BoxFit.fitWidth,),
                    Positioned.fill(
                      left: 15.0,
                      top: 240.0,
                      child: Text("Falling Asleep",style: TextStyle(
                          color: Colors.white,
                          fontSize: 25.0,
