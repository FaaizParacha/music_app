...
class _AnxietyState extends State<Anxiety> {
  ...
  void initState() {
    ...
    _player4 = AudioPlayer();
     ...
     _player1
           .setAsset("audios/Soothing Flute.mp3")
            .catchError((error){
              print(error);
     });
    _player2
        .setAsset("audios/Submarine.mp3")
        .catchError((error){
      print(error);
    });
    _player3
        .setAsset("audios/Walking past lake.mp3")
        .catchError((error){
      print(error);
    });
    _player4
        .setAsset("audios/Water fountain.mp3")
        .catchError((error){
      print(error);
    });
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Stack(
                children: <Widget>[
                  Image.asset("assets/1.jpeg",fit: BoxFit.fitWidth,),
                  Positioned.fill(
                    left: 15.0,
                    top: 150.0,
                    child: Text("Anxiety And Stress",style: TextStyle(
                        color: Colors.white,
                        fontSize: 25.0,
...
class _SeekBarState extends State<SeekBar> {
  ...
  @override
  Widget build(BuildContext context) {
    return Slider(activeColor: Colors.black,
      min: 0.0,
