...
class _RelaxState extends State<Relax> {
  ...
  void initState() {
    ...
    _player1
        .setAsset("audios/Fireplace.mp3")
        .catchError((error){
      print(error);
    });
    _player2
        .setAsset("audios/Lake.mp3")
        .catchError((error){
      print(error);
    });
    _player3
        .setAsset("audios/Ocean.mp3")
        .catchError((error){
      print(error);
    });
    _player4
        .setAsset("audios/RainforestGetaway.mp3")
        .catchError((error){
      print(error);
    });
        ...
        body: SingleChildScrollView(
          child: Column(
              children: [
                Stack(
                  children: <Widget>[
                    Image.asset("assets/2.jpeg",fit: BoxFit.fitWidth,),
                    Positioned.fill(
                      left: 15.0,
                      top: 240.0,
